...
| isin | International Securities Identification Number | 32% |
| cusip | CUSIP identifier | 1% |
...
| Metric | Value |
|--------|------:|
| Canonical equities | 18,077 |
| Sectors | 31 |
| Industries | 245 |
| Listing venues (MICs) | 10 |
| Daily snapshots | 70 |
| History since | 16/02/2026 |
| Aggregate market cap | $7.94T |
| Largest market cap | $732.82B |
| Median market cap | $253M |
| Price within 52-week range | 99% |
| Market cap within 25% of price × shares | 97% |
<!-- STATS:END -->
