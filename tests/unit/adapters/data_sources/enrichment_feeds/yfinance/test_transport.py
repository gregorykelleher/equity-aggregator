...
async def test_get_retries_on_protocol_error() -> None:
    """
    ARRANGE: client that always raises ProtocolError
...
async def test_handle_connection_error_returns_true_when_client_already_reset() -> None:
    ...
    result = await transport._handle_connection_error(old_client_id)
...
async def test_reset_uses_client_factory_to_create_new_client() -> None:
    ...
    ACT:     trigger reset via ProtocolError
