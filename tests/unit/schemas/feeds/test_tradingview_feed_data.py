...
def test_convert_percentage_to_decimal_converts_correctly() -> None:
    ...
    """
    result = _convert_percentage_to_decimal(20.6)

    assert result == Decimal("0.206")
...
def test_convert_percentage_to_decimal_handles_none() -> None:
    ...
    ASSERT:  returns None
    """
    result = _convert_percentage_to_decimal(None)
...
def test_convert_percentage_to_decimal_handles_zero() -> None:
    ...
    ASSERT:  returns 0.0
    """
    result = _convert_percentage_to_decimal(0.0)
...
def test_convert_percentage_to_decimal_handles_invalid_value() -> None:
    ...
    ASSERT:  returns None
    """
    result = _convert_percentage_to_decimal({"invalid": "object"})
...
def test_percentage_conversion_handles_negative_values() -> None:
    ...
    """
    result = _convert_percentage_to_decimal(-5.5)
