...
def test_fuzzy_cluster_mode_similar_strings() -> None:
    ...
    """
    result = fuzzy_cluster_mode(["Apple Inc", "Apple Inc.", "APPLE INC"])
...
def test_fuzzy_cluster_mode_best_cluster_by_weight() -> None:
    ...
    result = fuzzy_cluster_mode(values)
    assert result == "Apple Inc"
...
def test_fuzzy_cluster_mode_custom_threshold() -> None:
    ...
    result = fuzzy_cluster_mode(values, threshold=50)
...
def test_filter_by_deviation_removes_outliers() -> None:
    ...
    result = filter_by_deviation(values, max_deviation=Decimal("0.5"))
...
def test_filter_by_deviation_custom_threshold() -> None:
    ...
    result = filter_by_deviation(values, max_deviation=Decimal("0.1"), min_samples=3)
